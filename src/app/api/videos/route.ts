...
/** Önce shelbynet indexer dene (çalışıyor olabilir), sonra testnet. */
...
/** Shelby indexer + isteğe bağlı kayıt. Indexer testnet'te veri dönmeyebilir; ENABLE_VIDEO_REGISTRY=true ile kayıt kullanılır. */
